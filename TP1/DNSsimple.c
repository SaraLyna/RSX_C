...
#define DESTNAME "dns1.univ-lille.fr" /* "ns1.univ-lille.fr" (mais sans reponse des exterieurs de l'universite) */
#define DESTPORT "53"

#else

#define DESTIPV4 "10.140.6.45"      /* "194.254.129.102"   (mais sans reponse des exterieurs de l'universite)*/
#define DESTPORT 53
